...
const Option31 = ({setShowPrevious, setShowCurrent}: FunnelOptionPropsInterface) => {
            ...
            {showOptions && <div className="problemBoxContainer">
                ...
                <div className="d-flex flex-column align-items-center">
                    ...
                    <div>
                        ...
                        <div onClick={handleLeaveCommentClick} className="problemBox">Užvedus automobilį, stovint
                            vietoje
                        </div>
                        <div onClick={handleLeaveCommentClick} className="problemBox">Pradedant judėti iš vietos</div>
                    </div>
                </div>
            </div>}
