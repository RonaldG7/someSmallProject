...
const Option66 = ({setShowPrevious, setShowCurrent}: FunnelOptionPropsInterface) => {
        ...
        <div className="funnelContainer">
            {showOptions && <div className="problemBoxContainer">
                ...
                <div className="d-flex flex-column align-items-center">
                    ...
                    <div>
                        <div onClick={handleLeaveCommentClick} className="problemBox">Iš priekio</div>
                        <div onClick={handleLeaveCommentClick} className="problemBox">iš galo</div>
                        <div onClick={handleLeaveCommentClick} className="problemBox">Per vidurį</div>
                    </div>
                </div>
            </div>}
