...
const Option63 = ({setShowPrevious, setShowCurrent}: FunnelOptionPropsInterface) => {
        ...
        <div className="funnelContainer">
            {showOptions && <div className="problemBoxContainer">
                ...
                <div className="d-flex flex-column align-items-center">
                    ...
                    <div className="funnelHeadersCaption tex-align-center">Ar tiksėjimas greitėja paspaudus
