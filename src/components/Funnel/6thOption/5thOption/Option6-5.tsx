...
const Option65 = ({setShowPrevious, setShowCurrent}: FunnelOptionPropsInterface) => {
        ...
        <div className="funnelContainer">
            {showOptions && <div className="problemBoxContainer">
                ...
                <div className="d-flex flex-column align-items-center">
                    ...
                    <div>
                        <div onClick={handleLeaveCommentClick} className="problemBox">Garsas nepraeina sustabdžius
                            automobilį
                        </div>
                        <div onClick={handleLeaveCommentClick} className="problemBox">Garsas dingsta kai nespaudžiamas
                            akseleratorius
                        </div>
