...
const Option622 = ({setShowPrevious, setShowCurrent}: FunnelOptionPropsInterface) => {
        ...
        <div className="funnelContainer">
            {showOptions && <div className="problemBoxContainer">
                ...
                <div className="d-flex flex-column align-items-center">
                    ...
                    <div>
                        <div onClick={handleLeaveCommentClick} className="problemBox">Garsas didėja pradėjus važiuoti
                        </div>
                        <div onClick={handleLeaveCommentClick} className="problemBox">Garsas toks pats</div>
