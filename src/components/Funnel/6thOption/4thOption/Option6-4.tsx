...
const Option64 = ({setShowPrevious, setShowCurrent}: FunnelOptionPropsInterface) => {
            ...
            {showOptions && <div className="problemBoxContainer">
                ...
                <div className="d-flex flex-column align-items-center">
                    ...
                    <div>
                        ...
                        <div onClick={handleLeaveCommentClick} className="problemBox">Per viduri</div>
                    </div>
                </div>
            </div>}
