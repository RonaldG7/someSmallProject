...
const FinalOption = ({setShowPrevious, setShowCurrent}: FunnelOptionPropsInterface) => {
        ...
        <div className="funnelContainer">
            {showOptions && <div className="problemBoxContainer">
                ...
                <div className="d-flex flex-column align-items-center">
                    ...
                    <div>
                        <div onClick={handleLeaveCommentClick} className="problemBox">Sklinda iš galo</div>
                        <div onClick={handleLeaveCommentClick} className="problemBox">Sklinda iš variklio srities</div>
                        <div onClick={handleLeaveCommentClick} className="problemBox">Nežinau iš kur</div>
                    </div>
                </div>
            </div>}
